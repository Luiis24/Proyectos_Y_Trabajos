      ...
      if (respuesta.status === 200) {
        ...
        const fetchTrailer = async () => {
          try {
            ...
            const apiKey = '001eb5474c1b52412b728d71a0ef4514'; // Tu API key de TMDb
        ...
        // Llamar a la función 'fetchTrailer' para obtener el trailer y actualizar el iframe
        fetchTrailer();
      }
    } catch (error) {
      console.log(error);
    ...
    try {
      ...
      if (respuesta.status === 200) {
        ...
        datos.results.forEach((comentario) => {
          let comentarioRecortado = comentario.content.substring(0, 200); // Establece el límite de caracteres deseado
          let mostrarBotonLeerMas = comentario.content.length > 200; // Verifica si el comentario excede el límite

          // Obtener la URL de la foto de perfil
          let fotoPerfil = "https://www.millsjewelers.com/wp-content/uploads/2023/02/mystery-person.jpg"; // Foto predeterminada en caso de que no haya disponible
